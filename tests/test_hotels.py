...
def test_login_success(valid_user, login_page, smartdesk_page):
    ...
    login_page.login(valid_user.login, valid_user.password)
...
def test_login_with_invalid_password(invalid_user, login_page):
    ...
    login_page.navigate_to_login_page()
    login_page.login(invalid_user.login, invalid_user.password)
    login_page.check_login_failed()


def test_search_button_enables(
    login_page, smartdesk_page, hotels_search_page, name_region_search, valid_user):
